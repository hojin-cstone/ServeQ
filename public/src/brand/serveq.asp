...
<body class="sub">
	...
	<main id="wrap" class="<%= path1dir %>">
		<div id="contents" class="<%= path2dir %>">
			...
			<section class="<%= path3dir %> serveq1">
				...
				<div class="cont intro">
					...
					<p>
						...
						<span>
						보다 완벽하고 안전한 성공을 위한 식자재 유통의 베스트 솔루션 서브큐는<br />
						‘생활을 풍요롭고 편리하게 하는 기업’이라는 삼양사의 기업정신 위에서 태어났습니다.<br />
						믿을 수 있는 상품을 제공하고 고객의 Needs를 충족시킬 수 있는 전문적인 맞춤형 Solution을<br />
						제공하고 있으며, 고객이 만족할 수 있는 Best 가격으로 상품을 제공하려 노력하고 있습니다.<br />
						고객에게 신뢰받는 식자재 Total Solution Provider가 되어 고객과 함께 성장하겠습니다.
						</span>
					</p>
				</div>
				...
				<div class="cont motif">
					<h3>Design Motif</h3>
					<p>
						‘ServeQ’의 디자인 모티프는 두 개 원형의 결합으로 서브큐와 고객과의 파트너십이라는 의미를 담아 개발했습니다. 원형 라인이 결합된 디자인은 Corporate Brand인 삼양사의 디자인 모티프와 큐원의 원형에서 기인하여 브랜드간에 시각적인 연계를 유지하고 있습니다.
					</p>
					<ul>
						<li>
							<b>Pantone 7409</b>
